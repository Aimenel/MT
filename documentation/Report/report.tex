...
\label{vcgPredicate}
%values: modeling the state does not involve any changes, same as checking a permission in a state.
...
In order to use the remove function defined, we again need to adapt the approach for inhaling and exhaling unquantified predicate permissions.
